...
const SIGNUP_CONFIRM_REDIRECT_URL = `${PUBLIC_SITE_URL}/auth-confirm.html`;
const RESET_PASSWORD_REDIRECT_URL = `${PUBLIC_SITE_URL}/reset-password.html`;
...
export function createAccountActions({
  ...
  const handleFetchAccountHistory = async () => {
    ...
    return fetchAccountHistory(user.id);
  };
